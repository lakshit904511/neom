      ...
      <div
        className={
          data1.btn === null
            ...
            : "  w-[800px] flex flex-col gap-[20px] justify-between"
        }
      >
        <div className="flex flex-col gap-[12px]">
          <p
            style={{ fontFamily: "Brown, sans-serif" }}
            className="text-left text-[18px] leading-[10px] tracking-[0.4px] text-[#222222] opacity-100"
          >
            {data1.text1}
          </p>
          <p
            style={{ fontFamily: "BrownLight, sans-serif" }}
            className="text-left text-[16px]  tracking-[0.35px] text-[#222222] opacity-100"
          >
            {data1.text2}
          </p>
        </div>
        ...
        {data1.btn === null ? (
          ...
          <div className="flex w-[800px] items-start space-x-10">
            {data1.check === 1 ? (
              <>
